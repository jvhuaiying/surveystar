...
from ai_provider.schemas import (
...
router = APIRouter(prefix="/ai-provider", tags=["AI提供商管理"])
...
@router.get("/", response_model=list[GetAiProviderResponseSchemas])
...
@router.get("/{id}", response_model=GetAiProviderResponseSchemas)
